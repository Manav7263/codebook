...
export const Register = () => {
  ...
  async function handleRegister(event){
    ...
    try{
      ...
      data.accessToken ? toast(<div><i className="bi bi-check-circle"></i> Successfully Registred!! </div>,{position:"top-right",autoClose: 3000,hideProgressBar: false,closeOnClick: true,pauseOnHover: false, closeButton:true,theme:"colored",className: 'my-custom-toast-register'}) && navigate("/products") : toast.error(data);

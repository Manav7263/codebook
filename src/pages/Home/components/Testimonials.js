export const Testimonials = () => {
  ...
  <section className='my-20 '>
          ...
          <div className="grid mb-8 rounded-lg border border-gray-200 shadow-sm dark:border-gray-600 md:mb-12 md:grid-cols-2">
              <figure className="flex flex-col justify-center items-center p-8 text-center bg-white rounded-t-lg border-b border-gray-200 md:rounded-t-none md:rounded-tl-lg md:border-r dark:bg-gray-700 dark:border-gray-600">
                  ...
                  <figcaption className="flex justify-center items-center space-x-3">
                      <img className="w-9 h-9 rounded-full" src="https://source.unsplash.com/man-wearing-henley-top-portrait-7YVZYZeITc8" alt="user" />
              ...
              <figure className="flex flex-col justify-center items-center p-8 text-center bg-white rounded-tr-lg border-b border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                  <blockquote className="mx-auto mb-4 max-w-2xl text-gray-500 lg:mb-8 dark:text-gray-400">
                  ...
                  <figcaption className="flex justify-center items-center space-x-3">
                      ...
                      <div className="space-y-0.5 font-medium dark:text-white text-left">
                          <div>Khushi Patel</div>
                          <div className="text-sm font-light text-gray-500 dark:text-gray-400">Lead designer at Random</div>
                      </div>
                  </figcaption>    
              </figure>
              <figure className="flex flex-col justify-center items-center p-8 text-center bg-white rounded-bl-lg border-b border-gray-200 md:border-b-0 md:border-r dark:bg-gray-700 dark:border-gray-600">
                  <blockquote className="mx-auto mb-4 max-w-2xl text-gray-500 lg:mb-8 dark:text-gray-400">
                  ...
                  <figcaption className="flex justify-center items-center space-x-3">
                      ...
                      <div className="space-y-0.5 font-medium dark:text-white text-left">
                          <div>Rudra Sonani</div>
                          <div className="text-sm font-light text-gray-500 dark:text-gray-400">Software Engineer at Random</div>
                      </div>
                  </figcaption>    
              </figure>
              <figure className="flex flex-col justify-center items-center p-8 text-center bg-white rounded-b-lg border-gray-200 md:border-b-0 md:border-r dark:bg-gray-700 dark:border-gray-600">
                  <blockquote className="mx-auto mb-4 max-w-2xl text-gray-500 lg:mb-8 dark:text-gray-400">
